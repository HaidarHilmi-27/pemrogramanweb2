...
class NilaiMahasiswa{
    ...
    public function getNA() {
        ...
        ($this->nilai_uas * self::PERSENTASE_UAS) + ($this->nilai_uts * self::PERSENTASE_TUGAS);
    }

    // public function getNilaiAkhir(){
    //     $nilai_akhir = $this->nilai_uts * self::PERSENTASE_UTS + $this->nilai_uas * self::PERSENTASE_UAS + 
